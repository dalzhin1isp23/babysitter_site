...
<body>
    ...
    <div class="reger">
        <p>Регестрация</p>
        <input type="text" class="search"style="width: 80%;"placeholder="Логин">
        ...
        <input type="text" class="search"style="width: 80%;"placeholder="Повтор пароля">
        <div>
            <input type="checkbox" class="pole"style="float:left;">
            <p>Я соглашаюсь с условиями соглашения</p>
        </div>
        <button class="but_nav" style="background-color: #312815;width: 200px;border-radius: 20px;color: antiquewhite;">регестрирация</button>
        <a class="but_nav" style="background-color: #312815;width: 200px;border-radius: 20px;color: antiquewhite;" href="">логин</a>
